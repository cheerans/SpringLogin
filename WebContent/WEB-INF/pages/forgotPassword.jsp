...
<title></title>
 ...
 <body>    
	...
	<hr/>
	<div align="center">
		<form:form method="POST" commandName="fpass" action="forgotPassword.do">
		<form:errors path="*" cssClass="errorblock" element="div" />
		 <font size="8" color="brown">Forgot Password ???</font><br/><br/>
		 <table>	 
			 <tr bgcolor="#FFFFFF">
			 ...
			 <tr bgcolor="#FFFFFF">
			      ...
			      <td align="left">
			         <form:input path="password" readonly="readonly" size="30" maxlength="120"/>
			      </td>
			 </tr>
			 <tr bgcolor="#FFFFFF">
		...
		<br/><br/>
		<div align="center"><input type="submit" value="Generate New Password"></div>
		</form:form>
	</div>
</body>
</html>